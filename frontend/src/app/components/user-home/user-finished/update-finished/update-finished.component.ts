...
@Component({
  selector: 'app-update-finished',
  templateUrl: './update-finished.component.html',
  styleUrls: ['./update-finished.component.css']
})
export class UpdateFinishedComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<UpdateFinishedComponent>,
